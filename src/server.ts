...
export function sunucuOlustur(kaynaklar = KAYNAKLAR): McpServer {
  const server = new McpServer(
    ...
    {
      instructions: [
        "Türkiye'nin kamu verisi için araçlar: TCMB döviz kurları, AFAD deprem kataloğu, MGM hava durumu, Opet akaryakıt fiyatları, İstanbul trafik indeksi, BIST günlük fiyatlar, İBB/İzmir açık veri portalları, Resmî Gazete fihristi ve metinleri, resmî tatiller ve TCKN/VKN/IBAN biçim doğrulama.",
